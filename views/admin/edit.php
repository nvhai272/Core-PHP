        ...
        <form class="border p-4" action="/admin/edit-admin" method="POST" enctype="multipart/form-data">
            <div class="d-flex mb-3">
                ...
                <div class="flex-grow-1">
                    ...
                    <input type="text" name="email" class="form-control mb-2" value="<?php
                                                                                         echo htmlspecialchars(
            ...
            <input type="file" id="uploadFileAvatar" name="uploadFileAvatar" class="form-control mb-3" accept="image/*"
