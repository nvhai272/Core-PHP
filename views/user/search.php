...
$sortBy = in_array($_GET['sortBy'] ?? 'id', ['id', 'name', 'email','status']) ? $_GET['sortBy'] : 'id';
        ...
        <table class="table table-bordered">
            <thead class="table-primary">
                <tr>
                    ...
                    <th><a href="<?php echo getSortUrl('status', $queryString, $nextSortOrder); ?>">Status</a></th>
                </tr>
            </thead>
            <tbody>
                <?php foreach ($data ?? [] as $admin): ?>
                    <tr>
                        ...
                        <td><?php echo $admin['status'] == 1 ? 'Active' : 'Baned'; ?></td>
                    </tr>
                <?php endforeach; ?>
                <?php if (empty($data)): ?>
